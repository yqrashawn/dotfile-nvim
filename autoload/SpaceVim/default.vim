...
"                 \ 'call zvim#util#CopyToClipboard(3)')
    ...
    call SpaceVim#mapping#def('nnoremap <silent>', '<Leader>ss', ':split<CR>:wincmd p<CR>:e#<CR>',
                \'Open previous buffer in split window' , 'split|wincmd p|e#')
    call SpaceVim#mapping#def('nnoremap <silent>', '<Leader>sv', ':vsplit<CR>:wincmd p<CR>:e#<CR>',
